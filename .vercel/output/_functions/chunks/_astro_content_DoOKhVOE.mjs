import { Z as UnknownContentCollectionError, tt as AstroError } from "./errors-data_B2GzEEWH.mjs";
import { c as isRemotePath, d as removeBase } from "./path_DSAdOJJi.mjs";
import { p as generateCspDigest, t as spreadAttributes, u as renderTemplate, x as unescapeHTML } from "./server_DgJS7_4V.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_BmoFSxzG.mjs");
